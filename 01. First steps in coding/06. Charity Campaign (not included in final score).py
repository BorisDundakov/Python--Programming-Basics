...
# 23 137687.2 Изчисляваме сумата, която се изкарва на ден за всеки един от продуктите,
#
# © SoftUni – https://softuni.org. Copyrighted document. Unauthorized copy, reproduction or use is not permitted.
# Follow us: Page 7 of 7
#
# 23 ->  Броят на дните, в които тече кампанията
# 8  -> Броят на сладкарите
# 14 -> Броят на тортите
# 30 -> Броят на гофретите
# 16 -> Броят на палачинките
